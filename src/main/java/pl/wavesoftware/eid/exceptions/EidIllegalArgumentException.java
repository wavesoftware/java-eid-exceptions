...
public class EidIllegalArgumentException extends EidRuntimeException {
     ...
     */
    public EidIllegalArgumentException(CharSequence eid) {
        super(eid);
    }
     ...
     */
    public EidIllegalArgumentException(CharSequence eid, String message) {
        super(eid, message);
    }
     ...
     *                later retrieval by the {@link #getMessage()} method.
     */
    public EidIllegalArgumentException(EidMessage message) {
        super(message);
    }
     ...
     *                later retrieval by the {@link #getMessage()} method.
     */
    public EidIllegalArgumentException(Eid id, String message) {
        super(id, message);
    }
     ...
     *              permitted, and indicates that the cause is nonexistent or
     */
    public EidIllegalArgumentException(Eid id, @Nullable Throwable cause) {
        super(id, cause);
    }
