...
public class EidIllegalArgumentException extends EidRuntimeException {
     ...
     */
    public EidIllegalArgumentException(String eid, String ref, Throwable cause) {
        super(eid, ref, cause);
    }
     ...
     */
    public EidIllegalArgumentException(String eid, Throwable cause) {
        super(eid, cause);
    }
     ...
     */
    public EidIllegalArgumentException(String eid, String ref) {
        super(eid, ref);
    }
     ...
     */
    public EidIllegalArgumentException(Eid id, Throwable cause) {
        super(id, cause);
    }
